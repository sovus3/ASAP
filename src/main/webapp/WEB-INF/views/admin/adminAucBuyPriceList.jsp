...
$(document).ready(function(){
	...
	$("#btnSearch").on("click", function(){
		...
		document.bbsForm.action="/admin/adminAucBuyPriceList";
...
<body>
														...
														<div class="row no-gutters">
															<div class="col-lg-5 col-md-3 col-sm-12 p-0">
																<select class="form-control" name="searchType" id="searchType">
																	<option value="">낙찰자 검색</option>
																	<option value="2" <c:if test = '${searchType eq "2"}'>selected</c:if>>아이디</option>
																</select>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 p-0">
																<input type="text" placeholder="Search..." class="form-control" name="searchValue" id="searchValue" value="" style="height: 51px !important;">
															</div>
															<div class="col-lg-1 col-md-3 col-sm-12 p-0">
																<button type="button" id="btnSearch" class="btn btn-base" style="color: black;">
											...
											<table>
												...
												<tbody>
													<c:if test="${!empty list}">
														<c:forEach var="auction" items="${list}" varStatus="status">
															<tr>
																<td width="100">
																	<img src="/resources/upload/vote/${auction.vrSeq}.png">
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${auction.aucSeq}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																...
																<td>
																	<div class="cell-inner">
																		<span>${auction.vrTitle}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${auction.artUserId}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${auction.aucStartTime}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${auction.vrStartPrice}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${auction.aucBuyPrice}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${auction.userId}</span>
																	</div>
																</td>
															</tr>
														</c:forEach>
	...
	<form name="bbsForm" id="bbsForm" method="post">
		...
		<!-- modelMapd의 변수 -->
		<input type="hidden" id="monthValue" name="monthValue" value="${monthValue}" /> <input type="hidden" id="searchType" name="searchType" value="${searchType}" />
		<!-- modelMapd의 변수 -->
