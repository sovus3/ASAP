												...
												<div class="card-body" style="background-color:#221f1f !important;">
									                ...
									                <div class="gen-blog-post">
								                        <div class="gen-blog-contain">
								                        	<h2><c:out value="${noticeBoard.nbTitle}"/></h2>
								                        	<br>
								                            <div class="gen-post-meta">
								                                <ul>
								                                    <li class="gen-post-author"><i class="fa fa-user"></i><c:out value="${noticeBoard.admId}"/></li>
								                                    <li class="gen-post-meta">
								                                    	<a href="#"><i class="fa fa-calendar"></i>${noticeBoard.regDate}</a>
								                                    </li>
								                                    <li class="gen-post-tag">
								                                        <a href="#"><i class="fa fa-tag"></i>공지사항</a>
								                                    </li>
								                                </ul>
								                            </div>
								                            <p><c:out value="${noticeBoard.nbContent}"/></p>
								                        </div>
													</div>
									                <!-- 게시물 상세 1개 끝 -->
