												...
												<tbody>
													<c:if test="${!empty list}">
														<c:forEach var="voteUpload" items="${list}" varStatus="status">
															<tr>
																<td width="100">
																	<img src="/resources/upload/vote/${voteUpload.vrSeq}.png">
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${voteUpload.vrSeq}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${voteUpload.userId}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																...
																<td>
																	<div class="cell-inner">
																		<span>${voteUpload.vrTitle}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${voteUpload.vrTotalCnt}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${voteUpload.vrStartDate}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<span>${voteUpload.vrEndDate}</span>
																	</div>
																</td>
																<td>
																	<div class="cell-inner">
																		<c:choose>
																			<c:when test="${voteUpload.aucSeq == 0}">
																				<input type="button" id="aucInsert" name="aucInsert"
																					onclick="aucInsert(${voteUpload.vrSeq})"
																					value="업로드">
																			</c:when>
																			<c:otherwise>
																				<span>업로드 완료</span>
