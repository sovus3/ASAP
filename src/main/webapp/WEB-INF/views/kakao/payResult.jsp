...
<script>
   $(document).ready(function() {
      ...
      let gubunCheck = $("#gubunCheck").val();
      let amount = $("#amount").val();
      console.log("orderNo", orderNo);
      console.log("gubunCheck", gubunCheck);
      console.log("amount", amount);
      if ($.trim($("#gubunCheck").val()) == "gubunCheckPoint") {
         $.ajax({
            type : "POST",
            url : "/user/userPointUpdate",
            data : {
               orderId : orderNo,
               amount : amount
            },
      ...
      if ($.trim($("#gubunCheck").val()) == "gubunCheckFee") {
         $.ajax({
            type : "POST",
            url : "/user/userFeeUpdate",
            data : {
               orderId : orderNo
            },
            datatype : "JSON",
...
<body>
            ...
            <main>
               <table>
                  ...
                  <tr>
                     ...
                     <td style="float:right;">${kakaoPayApprove.quantity}</td>
   ...
   <form name="kakaoResultForm" id="kakaoResultForm" method="post">
      ...
      <input type="hidden" name="amount" id="amount" value="${kakaoPayApprove.amount.total}" />
   </form>
</body>
</html>