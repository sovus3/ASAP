...
(function(jQuery) {
    ...
    var registerDependencies = function() {
            var PluginJsConfig = {
                "js_dependencies": {
                    "asyncloader.js": "/resources/js/vendor/asyncloader.js",
                    "asyncloader": "/resources/js/asyncloader.min.js?ver=1.0",
                    "circle-progress": "/resources/js/circle-progress.min.js?ver=1.0",
                    "isotope.pkgd": "/resources/js/isotope.pkgd.min.js?ver=1.0",
                    "jquery.countTo": "/resources/js/jquery.countTo.min.js?ver=1.0",
                    "jquery.magnific-popup": "/resources/js/jquery.magnific-popup.min.js?ver=1.0",
                    "owl.carousel": "/resources/js/owl.carousel.min.js?ver=1.0",
                    "slick": "/resources/js/slick.min.js?ver=1.0"
                }
            };
