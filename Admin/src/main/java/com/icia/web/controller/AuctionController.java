...
public class AuctionController {
	...
	public Response<Object> aucCurProc(HttpServletRequest request, HttpServletResponse response){
		...
		long aucCurPrice = HttpUtil.get(request, "aucCurPrice", (long)0);
		long aucSeq = HttpUtil.get(request, "aucSeq", (long)0);
	...
	public String mailSend(HttpServletRequest request, HttpServletResponse response) {
		 Properties prop = new Properties();
			...
			String formatedDate = "20230906";
			
            List<MyPageNmailSend> myPageNmailSend = auctionService.myPageNmailSendSelect(formatedDate); //이메일 주소
				...
				if(myPageNmailSend != null){
					for(int i = 0; i < myPageNmailSend.size(); i++) {
						...
						content = "<html>\r\n"
								...
								+ "<body>\r\n"
								+ "    <div>\r\n"
								+ "    <h3><strong>" + myPageNmailSend.get(i).getAcUserId() + "님</strong>, 낙찰을 축하드립니다.</h3>\r\n"
								+ "    <ul>\r\n"
								+ "        <li>낙찰 작품 내역</ol> <br>\r\n"
