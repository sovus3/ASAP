          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 style="color:black; margin-left:15px;">${noticeBoard.nbTitle}</h1>
                    <form class="forms-sample"> 
                    <div class="form-group h4" >
					    <ul style="list-style-type: none; display: flex;">
					        <li style=" display: flex; align-items: center; margin-right: 10px;">
					            <i class="mdi mdi-account"></i>&ensp;
					            <c:out value="${noticeBoard.admId}" />
					        </li>
					        &ensp;&ensp;
					        <li style="display: flex; align-items: center; margin-right: 10px;">
					            <i class="mdi mdi-calendar"></i>&ensp;${noticeBoard.regDate}
					        </li>
					        &ensp;&ensp;
					        <li style="display: flex; align-items: center;">
					            <i class="mdi mdi-tag-multiple"></i>&ensp;공지사항
					        </li>
					    </ul>
					</div> 
						<div class="form-group h3" style="color:#5F5F5F; margin-left: 15px; width:70%;">
						${noticeBoard.nbContent}
						</div>
