			...
			<div class="main-panel">
				<div class="content-wrapper">
						...
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								...
								<div class="form-group"
										...
										<input type="button" id="divWrite" class="btn btn-primary" value="글쓰기" >
										</div>
										</div>
								...
								<c:forEach var="noticeBoard" items="${list}" varStatus="status">
									<tr>
										...
										<td><a href="javascript:void(0)"
											onclick="fn_view(${noticeBoard.nbSeq})" style="color:#0062ff";">
												<span> <c:out value="${noticeBoard.nbTitle}" />
											</span>
										</a></td>
										<td>${noticeBoard.regDate}</td>
										<td>
										<c:if test="${gnbAdmId eq noticeBoard.admId }">
										<label class="badge badge-warning"
											onclick="fn_update(${noticeBoard.nbSeq})">수정</label> </c:if> &nbsp; <label
					...
					<form name="bbsForm" id="bbsForm" method="post">
						...
						<input type="hidden" name="admId" id="admId" value="${noticeBoard.admId}"/>
					</form>
