				...
				<div class="content-wrapper">
					...
					<div class="row">
						...
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">경매 낙찰내역</h4>
										...
										<div class="search-field d-none d-xl-block"
											...
											<div class="input-group-prepend bg-transparent"
												...
												<input type="text"
													...
													placeholder="낙찰자 검색..." name="searchValue" id="searchValue" value="${searchValue }">
												<div id="btnSearch"
										...
										<tbody>
											<c:if test="${!empty list}">
												<c:forEach var="auction" items="${list}" varStatus="status">
													<tr>
														<td width="100"><img
															src="/resources/upload/vote/${auction.vrSeq}.png">
														</td>
														<td>${auction.aucSeq}</td>
														<td>
															<div>
																<c:choose>
														...
														<td>${auction.vrTitle}</td>
														<td>${auction.artUserId}</td>
														<td>${auction.aucStartTime}</td>
														<td>
															<div>
																<span><fmt:formatNumber type="number" maxFractionDigits="3" value="${auction.vrStartPrice}"/></span>
															</div>
														</td>
														<td>
															<div>
																<span><fmt:formatNumber type="number" maxFractionDigits="3" value="${auction.aucBuyPrice}"/></span>
															</div>
														</td>
														<td>
															<div>
