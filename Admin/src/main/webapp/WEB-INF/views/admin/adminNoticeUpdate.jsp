              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <!--  수정  -->
                    <div class="form-group h5" >관리자 아이디 : ${noticeBoard.admId}</div>                     
                      <!--  수정  -->
                      <div class="form-group" >
                        <label for="exampleInputEmail3">제목 *</label>
                        <input type="text" style="width: 50%;" class="form-control" name="nbTitle" id="nbTitle" placeholder="제목을 입력해주세요." value="${noticeBoard.nbTitle}" >
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">내용 *</label>
                        <textarea class="form-control" rows="10" name="nbContent" id="nbContent"  placeholder="내용을 입력해주세요" >${noticeBoard.nbContent}</textarea>
                      </div> 
                      <input type="button" class="btn btn-secondary" id="btnList" value="  목록  " >
                  <input type="button" class="btn btn-primary ml-1" id="btnUpdate"  value="  수정  " >
                  </form>
                  </div>
                </div>
              </div>
